...
-- POWER PLANT: #%
local OverPowerPlant = { { 'C', "Coal Power" }, { 'G', "Geothermal" }, 
...
-- \c = Civil Defense
local OverCivil = { { 'R', "RACES" }, { 'S', "SATERN" },
											};
...
{ '"', "BC", "OC", tUndefined, "No Symbol", tUndefined, "No Symbol"},
...
{ '\'',"BH", "OH", tMobile, "Plane Sm", tSpecial, "Crash site", OverIncidentSites },
{ '(', "BI", "OI", tMobile, "Mob Sat Stn", tWeather, "Cloudy"},
{ ')', "BJ", "OJ", tMobile, "WheelChair", tInfra, "Firenet MEO" },	-- , &OverFirenet
{ '*', "BK", "OK", tMobile, "Snowmobile", tWeather, "Snow"},
{ '+', "BL", "OL", tMarker, "Red Cross", tAmenity, "Church"},
{ ' ', "BM", "OM", tSpecial, "Boy Scout", tSpecial, "Girl Scout"},
{ '-', "BN", "ON", tFixed, "Home", tFixed, "Home (HF)", OverHome },
{ '.', "BO", "OO", tMarker, "X", tSpecial, "UnknownPos"},
{ '/', "BP", "OP", tMarker, "Red Dot", tSpecial, "Destination"},

{ '0', "P0", "A0", tMarker, "Circle (0)", tMarker, "No. Circle", OverNodes },
{ '1', "P1", "A1", tMarker, "Circle (1)", tUndefined, "No Symbol"},
{ '2', "P2", "A2", tMarker, "Circle (2)", tUndefined, "No Symbol"},
{ '3', "P3", "A3", tMarker, "Circle (3)", tUndefined, "No Symbol"},
{ '4', "P4", "A4", tMarker, "Circle (4)", tUndefined, "No Symbol"},
{ '5', "P5", "A5", tMarker, "Circle (5)", tUndefined, "No Symbol"},
{ '6', "P6", "A6", tMarker, "Circle (6)", tUndefined, "No Symbol"},
{ '7', "P7", "A7", tMarker, "Circle (7)", tUndefined, "No Symbol"},
{ '8', "P8", "A8", tMarker, "Circle (8)", tUndefined, "No Symbol", OverNetwork },
...
{ 'C', "PC", "AC", tMobile, "Canoe", tFixed, "Coast G'rd"},
{ 'D', "PD", "AD", tUndefined, "No Symbol", tWeather, "Drizzle"},
...
{ 'J', "PJ", "AJ", tUndefined, "No Symbol", tWeather, "Lightning"},
...
{ 'O', "PO", "AO", tMobile, "Balloon", tMobile, "Rocket"},
{ 'P', "PP", "AP", tMobile, "Police", tMarker, "Parking  "},
{ 'Q', "PQ", "AQ", tUndefined, "TBD/Bullseye", tWeather, "Quake"},
{ 'R', "PR", "AR", tMobile, "Rec Veh'le", tAmenity, "Restaurant", OverRestaurant },
{ 'S', "PS", "AS", tMobile, "Shuttle", tInfra, "Sat/Pacsat"},
...
{ 'X', "PX", "AX", tMobile, "Helo", tAmenity, "Pharmacy"},
{ 'Y', "PY", "AY", tMobile, "Yacht", tMobile, "Radio or GPS", OverRadios },
{ 'Z', "PZ", "AZ", tBrand, "WinAPRS", tUndefined, "No Symbol"},

{ '[', "HS", "DS", tMobile, "Jogger", tWeather, "Wall Cloud", OverHuman },
{ '\\',"HT", "DT", tSpecial, "DF Triangle", tUndefined, "GPS Symbol", OverGPS },
{ ']', "HU", "DU", tInfra, "PBBS", tUndefined, "No Symbol"},
{ '^', "HV", "DV", tMobile, "Plane Lrge", tMobile, "No. Plane"},
{ '_', "HW", "DW", tWeather, "WX Service", tWeather, "No. WX Site" },
{ '`', "HX", "DX", tFixed, "Dish Ant.", tWeather, "Rain"},

{ 'a', "LA", "SA", tMobile, "Ambulance", tMarker, "No. Diamond", OverARRL },
{ 'b', "LB", "SB", tMobile, "Bike", tWeather, "Dust blwng"},
{ 'c', "LC", "SC", tMarker, "ICP", tFixed, "No CivDef", OverCivil },
{ 'd', "LD", "SD", tFixed, "Fire Station", tInfra, "DX Spot"},
{ 'e', "LE", "SE", tMobile, "Horse", tWeather, "Sleet"},
{ 'f', "LF", "SF", tMobile, "Fire Truck", tWeather, "Funnel Cld"},
{ 'g', "LG", "SG", tMobile, "Glider", tWeather, "Gale"},
{ 'h', "LH", "SH", tFixed, "Hospital", tFixed, "(HAM) Store", OverStore },
{ 'i', "LI", "SI", tFixed, "IOTA", tMarker, "No. Blk Box"},
{ 'j', "LJ", "SJ", tMobile, "Jeep", tMarker, "WorkZone"},
...
{ 'p', "LP", "SP", tMobile, "Rover", tWeather, "Part Cloud"},
{ 'q', "LQ", "SQ", tSpecial, "Grid squ.", tUndefined, "No Symbol"},
{ 'r', "LR", "SR", tInfra, "Antenna", tAmenity, "Restrooms"},
{ 's', "LS", "SS", tMobile, "Power Boat", tMobile, "No. Boat" },
...
{ 'x', "LX", "SX", tBrand, "XAPRS", tUndefined, "No Symbol"},
{ 'y', "LY", "SY", tInfra, "Yagi", tWeather, "Sky Warn"},
{ 'z', "LZ", "SZ", tFixed, "Shelter", tFixed, "No Shelter"},

{ '{', "J1", "Q1", tUndefined, "No Symbol", tWeather, "Fog"},
{ '|', "J2", "Q2", tSpecial, "TNC Stream Sw", tSpecial, "TNC Stream SW"},
{ '}', "J3", "Q3", tUndefined, "No Symbol", tUndefined, "No Symbol"},
...
for i, t in ipairs(SymbolNames) do
	...
	elseif #t ~= 7 and #t ~= 8 then
		print("Invalid Symbol["..i.."]("..tostring(t[1]).." Definition("..#t..") Needs 7 or 8 elements")
